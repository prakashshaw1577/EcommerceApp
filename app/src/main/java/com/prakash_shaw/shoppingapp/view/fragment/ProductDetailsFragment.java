 ...
 */
package com.prakash_shaw.shoppingapp.view.fragment;
...
import com.prakash_shaw.shoppingapp.model.entities.Money;
import com.prakash_shaw.shoppingapp.model.entities.Product;
import com.prakash_shaw.shoppingapp.util.ColorGenerator;
import com.prakash_shaw.shoppingapp.util.Utils;
import com.prakash_shaw.shoppingapp.util.Utils.AnimationType;
import com.prakash_shaw.shoppingapp.view.activities.ECartHomeActivity;
import com.prakash_shaw.shoppingapp.view.adapter.SimilarProductsPagerAdapter;
import com.prakash_shaw.shoppingapp.view.customview.ClickableViewPager;
import com.prakash_shaw.shoppingapp.view.customview.ClickableViewPager.OnItemClickListener;
import com.prakash_shaw.shoppingapp.view.customview.LabelView;
import com.prakash_shaw.shoppingapp.view.customview.TextDrawable;
import com.prakash_shaw.shoppingapp.view.customview.TextDrawable.IBuilder;
                        ...
                        public void onError() {
                            ...
                            Picasso.with(getActivity())
                                    .load(CenterRepository.getCenterRepository()
                                            ...
                                            .get(productListNumber)
                                            .getImageURL())
                                    .placeholder(drawable).error(drawable).into(itemImage);
                        }
                    });
